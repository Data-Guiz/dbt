...
WITH source_data AS (
    SELECT
    fms_spr__fms_shp__fms_dep__fms_pos__fms_spa_hk::VARCHAR(40) AS fms_spr__fms_shp__fms_dep__fms_pos__fms_spa_hk
    ...
    FROM {{ source('dv', 'link_fms_spr__fms_shp__fms_dep__fms_pos__fms_spa') }}
)
